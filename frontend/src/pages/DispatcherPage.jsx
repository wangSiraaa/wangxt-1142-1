...
export default function DispatcherPage({ user, onLogout }) {
  ...
  const reqColumns = [
    ...
    { title: '需求数量', dataIndex: 'quantity', key: 'quantity', width: 100 },
    ...
    { title: '调度员', dataIndex: 'dispatcher_name', key: 'dispatcher_name', width: 100 },
            ...
            <>
              <Card style={{ marginBottom: 16 }}>
                <Row gutter={16}>
                  ...
                  <Col span={6}>
                    <Statistic
                      title="航线"
                      value={`${selectedFlight.departure} → ${selectedFlight.arrival}`}
                    />
                  </Col>
                  <Col span={6}>
                    <Statistic
                  ...
                  <Col span={6}>
                    <Statistic
                      title="旅客人数"
                      value={selectedFlight.passenger_count}
                      suffix="人"
                    />
                  </Col>
                </Row>
              ...
              <Card
                ...
                extra={
                  <Button
                    ...
                    disabled={new Date(selectedFlight.scheduled_departure_time) <= new Date()}
                  >
                    添加需求
                  </Button>
                }
              >
                <Table
                  ...
                  pagination={false}
                />
                {new Date(selectedFlight.scheduled_departure_time) <= new Date() && (
      ...
      >
        <Form form={flightForm} layout="vertical" onFinish={handleSubmitFlight}>
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: '请输入旅客人数' }]}
          >
